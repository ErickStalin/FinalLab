        ...
        <>
            <div className="bg-white flex justify-center items-center w-1/2 h-screen">
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-2 text-center uppercase text-gray-500">Welcome back</h1>
                    <small className="text-gray-400 block my-4 text-sm sm:text-base">Welcome back! Please enter your details</small>
